    ...
    <section class="hero-v2 internal-hero">
      ...
      <div class="container hero-container">
        <div class="hero-content-v2">
          <div class="internal-badge">NOS RÉALISATIONS</div>
          <h1>
            Des solutions <span class="serif-text">concrètes</span> <br/>
            pour un <span class="highlight">impact réel</span>
          </h1>
          <p class="hero-lead">
            Découvrez comment nous avons aidé nos clients à atteindre leurs objectifs grâce à des solutions digitales innovantes et durables.
          </p>
        ...
        <div class="hero-image-v2">
          <div class="image-continuous image-projects"></div>
        </div>
      </div>
    </section>
...
.image-projects {
  background-image: url('https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=1280&q=80');
}
