<template>
  <div class="pole-page">
    ...
    <section class="page-hero">
      <div class="hero-bg">
        <img src="https://www.scidev.net/afrique-sub-saharienne/wp-content/uploads/sites/2/2019/08/young_researchers_visit_an_agriculture_research_station_in_kenya.jpg" alt="Pôle Recherche" />
      ...
      <div class="hero-content">
        ...
        <h1>R&D & <span class="gradient-text">Innovation</span></h1>
        <p>Recherche et développement de solutions technologiques de pointe.</p>
      </div>
    </section>
